...
//         const shipWidth = window.innerWidth * 0.08; // 15vw
...
//         gsap.to(shipDimensions, {
//             y: window.innerHeight * 1.5, // End position
//             scrollTrigger: {
//                 trigger: vision,
//                 start: "center center",
//                 end: "bottom+=800% top",
...
//                     // Draw ship with current position
//                     ctx.save();
                    
//                     // Set opacity based on scroll position
//                     if (self.progress < 0.1) {
//                         ctx.globalAlpha = self.progress * 10;
//                     } else if (self.progress > 0.9) {
//                         ctx.globalAlpha = (1 - self.progress) * 10;
//                     } else {
//                         ctx.globalAlpha = 1;
//                     }
...
//         // Set canvas size to match full document height
//         canvas.width = window.innerWidth;
...
//         // Position canvas absolutely with full document height
...
//         shipImage.onload = () => {
//             // Calculate initial position just below vision section
//             const shipWidth = window.innerWidth * 0.08;
//             const aspectRatio = shipImage.height / shipImage.width;
//             const shipHeight = shipWidth * aspectRatio;
//             const visionBottom = vision.offsetTop + vision.offsetHeight;
            
//             // Store ship dimensions with initial position below vision section
//             const shipDimensions = {
//                 width: shipWidth,
//                 height: shipHeight,
//                 x: (window.innerWidth - shipWidth) / 2,
//                 y: visionBottom + 20, // Small offset from vision section
//                 initialY: visionBottom + 20 // Store initial position for animation
//             };

//             // Draw initial static ship
//             ctx.drawImage(
//                 shipImage,
//                 shipDimensions.x,
//                 shipDimensions.y,
...
//             // Create scroll animation that only starts when timeline section is in view
//             gsap.to(shipDimensions, {
//                 y: section.offsetTop + section.offsetHeight, // End at bottom of timeline section
//                 scrollTrigger: {
//                     trigger: section,
//                     start: "top center",
//                     end: "bottom bottom",
...
//             // Redraw ship if image is loaded
...
//         // Store ship dimensions with initial position
//         const shipDimensions = {
//             width: shipWidth,
//             height: shipHeight,
//             x: (window.innerWidth - shipWidth) / 2,
//             y: visionBottom + 20,
//             initialY: visionBottom + 20
//         };
...
//         // Calculate the distance to move based on timeline section height
//         const timelineHeight = section.offsetHeight;
//         const startY = shipDimensions.y;
//         const endY = section.offsetTop + timelineHeight - shipHeight;
...
//         // Create scroll animation
//         // gsap.to(shipDimensions, {
//         //     y: startY + window.innerHeight * 1.5, // Move down by 1.5 viewport heights
//         //     ease: "none",
//         //     scrollTrigger: {
//         //         trigger: section,
//         //         start: "top top",
...
//         const endY = section.offsetTop + section.offsetHeight - shipHeight;
...
//                 scrub: 1,
//                 onUpdate: self => {
//                     shipDimensions.y = gsap.utils.interpolate(
//                         visionBottom - 200,
//                         endY,
//                         self.progress
//                     );
...
//         const startY = visionBottom - 200;
//         const travelDistance = window.innerHeight * 1.2; // Adjust this multiplier to control travel distance
...
//                 scrub: 1,
//                 onUpdate: (self) => {
//                     // Move down as progress increases
//                     shipDimensions.y = startY + (travelDistance * self.progress);
//                     drawShip();
//                 }
//             }
//         });
