    ...
    <>
        <div className='w-full h-full md:p-[2vw] lg:p-[4vw] px-4 py-4'>
            <div className='flex flex-col md:flex-row justify-between w-full gap-[12vw] md:gap-0 items-center '>
                <div className='md:w-[40%] flex flex-col gap-[4vw] md:gap-[1vw]'>
                    <div className={`text-[#02123b] ${Clash.className} text-[8vw] leading-[1.4] sm:leading-[1.2] md:leading-none md:text-[5vw] lg:text-[4vw]`}> Explore Our 
