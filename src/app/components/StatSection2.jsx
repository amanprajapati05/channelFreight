      ...
      <div className="relative w-[80vw] h-[80vw] sm:w-[50vw] sm:h-[50vw] md:w-[25vw] md:h-[25vw] lg:w-[20vw] lg:h-[20vw] flex items-center justify-center mx-auto">
        ...
        >
          <g>
            <path
              ref={circleRef}
              className="stroke-[#02123b] fill-none"
              strokeWidth="2"
              strokeLinecap="round"
        ...
        <div 
          ref={dotRef}
          className="absolute w-2 h-2 bg-[#02123b] rounded-full"
        />
        
        <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full ${Clash.className}`}>
          <div className="text-[6vw] sm:text-[4vw] md:text-[2vw] lg:text-[1.5vw] text-[#02123b] whitespace-pre-line font-bold">
            {title}
          </div>
          <div className="text-[3vw] sm:text-[2vw] md:text-[1vw] lg:text-[0.8vw] text-[#02123b] mt-2 px-[4vw] md:px-[2vw]">
            {description}
          </div>
        </div>
      </div>
...
const StatsSection2 = () => {
  ...
  return (
    <section ref={sectionRef} className="relative z-50 stats-section">
      <div className="w-full flex md:flex-row flex-col items-center justify-center gap-8 bg-white py-16">
