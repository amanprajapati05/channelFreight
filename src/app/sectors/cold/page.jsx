...
//     <ServicesPage title={'cold chain products'} img1={'/images/sectors/img61.png'} img2={'/images/sectors/img62.png'} desc={'Cold chain logistics is vital for industries such as healthcare, food, agriculture, and chemicals. It involves the seamless movement of perishable goods under strict temperature controls to preserve quality and safety.'}/>
...
const page = () => {
  ...
  useEffect(() => {
    const scrollInstance = new locomotiveScroll({
      ...
      smooth: true,
      smoothMobile: true,
      multiplier: 0.4, // Adjust the speed of the scrolling (lower is slower)
