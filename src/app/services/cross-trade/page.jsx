...
<div  className='w-full h-full  pt-[2vw]'>
        <div   className='flex md:w-full flex-nowrap overflow-x-auto scrollbar-hide  md:mx-0 justify-between gap-[4vw] pt-[6vw] md:gap-[2vw]'>   
        ...
        <div className={`${Clash.className} lg:text-[1vw] md:text-[1.8vw] text-[3vw] text-[#02123b] leading-[0] pb-[2vw] md:pb-0`}>Success Rate</div>
                ...
                <div className=' h-[64%] bg-[#02123b] rounded-2xl md:px-[1vw] px-[3vw] '>
                    ...
                    <div className='flex justify-center items-center h-[90%] relative'>
                        ...
                        <div className={`${ClashM.className} px-3 pl-6 md:pl-0  md:text-[1.6vw] md:text-center text-[4vw] text-white `}>Navigating borders, unlocking global opportunities.</div>
